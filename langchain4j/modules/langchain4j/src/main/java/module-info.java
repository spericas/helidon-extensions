...
@Features.Preview
module io.helidon.extensions.langchain4j {
    ...
    exports io.helidon.extensions.langchain4j;

    provides dev.langchain4j.spi.services.TokenStreamAdapter
            with io.helidon.extensions.langchain4j.TokenStreamToStreamAdapter;
    provides dev.langchain4j.spi.classloading.ClassInstanceFactory
            with io.helidon.extensions.langchain4j.ServiceRegistryClassInstanceFactory;
}

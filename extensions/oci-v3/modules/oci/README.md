...
The provider is looked up by using instances of `io.helidon.extensions.oci.v3.spi.OciAuthenticationMethod`. The first service instance to provide an authentication provider is used, and no other service instance is called.
...
Region is discovered by using instances of `io.helidon.extensions.oci.v3.spi.OciRegion`. The first service instance to provide a
...
The `IMDS` instance information is discovered by simply using an instance of `io.helidon.extensions.oci.v3.ImdsInstanceInfo`.
The following fields are provided from `io.helidon.extensions.oci.v3.ImdsInstanceInfo`:
- canonicalRegionName
- displayName
- hostName
- region

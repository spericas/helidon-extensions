...
/**
 * Initial Eureka Server service instance registration lease details.
 * <p>
 * This interface is deliberately modeled to closely resemble the {@code com.netflix.appinfo.LeaseInfo} class for
 * familiarity.
 * <p>
 * Its configuration is deliberately modeled to closely resemble that expressed by the {@code

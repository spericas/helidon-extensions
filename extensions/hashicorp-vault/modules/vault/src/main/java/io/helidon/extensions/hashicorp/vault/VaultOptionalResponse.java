...
import io.helidon.extensions.hashicorp.vault.rest.ApiOptionalResponse;
...
public final class VaultOptionalResponse<R> extends ApiOptionalResponse<R> {
    ...
    /**
     * Fluent API builder for {@link io.helidon.extensions.hashicorp.vault.VaultOptionalResponse}.
     *
     * @param <X> type of entity (actual entity on HTTP communication, such as {@link io.helidon.json.JsonObject})
    ...
    /**
     * Base builder class for subclasses of {@link io.helidon.extensions.hashicorp.vault.VaultOptionalResponse}.
     *

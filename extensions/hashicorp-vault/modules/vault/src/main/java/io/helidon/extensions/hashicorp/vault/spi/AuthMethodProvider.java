...
import io.helidon.extensions.hashicorp.vault.AuthMethod;
...
public interface AuthMethodProvider<T> {
     ...
     * @see io.helidon.extensions.hashicorp.vault.Vault#auth(io.helidon.extensions.hashicorp.vault.AuthMethod)
     */

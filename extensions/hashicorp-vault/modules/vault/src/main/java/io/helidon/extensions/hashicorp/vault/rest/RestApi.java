...
import io.helidon.extensions.hashicorp.vault.rest.ApiOptionalResponse.BuilderBase;
...
public interface RestApi {
     ...
     *                        {@link io.helidon.extensions.hashicorp.vault.rest.ApiJsonRequest} if
     ...
     * The entity is expected to be missing if {@link io.helidon.http.Status#NOT_FOUND_404} is returned by the API call (and for
     * some
     ...
     * @param <T> type of the built {@link io.helidon.extensions.hashicorp.vault.rest.RestApi}
     */
    abstract class Builder<B extends Builder<B, T>, T extends RestApi> implements io.helidon.common.Builder<B, T> {
        ...
        /**
         * Build an instance of {@link io.helidon.extensions.hashicorp.vault.rest.RestApi} implementation.
         *

 ...
 * For responses that may have an entity, use {@link io.helidon.extensions.hashicorp.vault.rest.ApiOptionalResponse},
 * for responses that must have an entity, use {@link io.helidon.extensions.hashicorp.vault.rest.ApiEntityResponse}.
 */
public abstract class ApiResponse extends ApiJsonParser {
    ...
    public abstract static class Builder<B extends Builder<B, T>, T extends ApiResponse>
         ...
         * This may be generated by {@link io.helidon.extensions.hashicorp.vault.rest.RestApi}
         *
         * @return request id
         */
        public String requestId() {

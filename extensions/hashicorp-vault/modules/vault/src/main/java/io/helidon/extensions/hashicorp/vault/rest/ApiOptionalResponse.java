...
public class ApiOptionalResponse<R> extends ApiResponse {
     ...
     *
     * @param <X> expected entity (such as {@link io.helidon.json.JsonObject}
    ...
    /**
     * Fluent API builder for {@link io.helidon.extensions.hashicorp.vault.rest.ApiOptionalResponse}.
     *
     * @param <X> type of the entity, such as{@link io.helidon.json.JsonObject}
    ...
    /**
     * Fluent API builder base for subclasses of {@link io.helidon.extensions.hashicorp.vault.rest.ApiOptionalResponse}.
     *
     * @param <B> type of the builder (extending the base builder)
     * @param <T> type of the subclass of {@link io.helidon.extensions.hashicorp.vault.rest.ApiOptionalResponse}
    ...
    public abstract static class BuilderBase<B extends BuilderBase<B, T, X, R>, T extends ApiOptionalResponse<R>, X, R>
        ...
        /**
         * Configure the entity. Invoked by {@link io.helidon.extensions.hashicorp.vault.rest.RestApi}.
         *

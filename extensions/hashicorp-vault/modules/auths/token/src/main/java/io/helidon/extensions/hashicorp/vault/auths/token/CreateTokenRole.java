...
public final class CreateTokenRole {
    ...
    public static class Request extends VaultRequest<Request> {
         ...
         * {@link io.helidon.extensions.hashicorp.vault.auths.token.CreateToken.Request#ttl(java.time.Duration)} and
         * {@link io.helidon.extensions.hashicorp.vault.auths.token.CreateToken.Request#explicitMaxTtl(java.time.Duration)} would

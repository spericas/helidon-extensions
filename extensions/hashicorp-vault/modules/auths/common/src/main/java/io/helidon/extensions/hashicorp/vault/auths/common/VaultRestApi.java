...
import io.helidon.extensions.hashicorp.vault.rest.ApiRestException;
import io.helidon.extensions.hashicorp.vault.rest.ResponseBuilder;
...
public class VaultRestApi extends RestApiBase {
    ...
    /**
     * Fluent API builder for {@link io.helidon.extensions.hashicorp.vault.auths.common.VaultRestApi}.
     */

...
module io.helidon.extensions.hashicorp.vault.auths.k8s {
    ...
    provides io.helidon.extensions.hashicorp.vault.spi.VaultAuth
            with io.helidon.extensions.hashicorp.vault.auths.k8s.K8sVaultAuth;

    provides io.helidon.extensions.hashicorp.vault.spi.AuthMethodProvider
            with io.helidon.extensions.hashicorp.vault.auths.k8s.K8sAuthProvider;

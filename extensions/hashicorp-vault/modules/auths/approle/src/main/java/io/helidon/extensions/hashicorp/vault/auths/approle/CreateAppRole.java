 ...
 */
public final class CreateAppRole {
    private CreateAppRole() {
    }
    ...
    public static class Request extends VaultRequest<Request> {
         ...
         * See
         * <a href="https://www.vaultproject.io/docs/concepts/tokens#token-time-to-live-periodic-tokens-and-explicit-max-ttls">
         * Period</a>
         *
     ...
     *
     * @see AppRoleAuth#createAppRole(io.helidon.extensions.hashicorp.vault.auths.approle.CreateAppRole.Request)
     */

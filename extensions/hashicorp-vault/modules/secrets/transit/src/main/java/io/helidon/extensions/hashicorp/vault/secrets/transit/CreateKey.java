...
public final class CreateKey {
    ...
    public static final class Request extends VaultRequest<Request> {
         ...
         *
         * <ul>
         *     <li>{@code aes128-gcm96} - AES-128 wrapped with GCM using a 96-bit nonce size AEAD (symmetric, supports
         *     derivation and convergent encryption)</li>
         *     <li>{@code aes256-gcm96} - AES-256 wrapped with GCM using a 96-bit nonce size AEAD (symmetric, supports
         *     derivation and convergent encryption, default)</li>
         *     <li>{@code chacha20-poly1305 - ChaCha20-Poly1305 AEAD (symmetric, supports derivation and convergent
         *     encryption)} - </li>
         *     <li>{@code ed25519} - ED25519 (asymmetric, supports derivation). When using derivation, a sign operation with
         *     the same context will derive the same key and signature; this is a signing analogue to convergent_encryption</li>

...
public final class Verify {
    ...
    public static class Request extends VaultRequest<Request> {
         ...
         *                  {@link TransitSecrets#sign(io.helidon.extensions.hashicorp.vault.secrets.transit.Sign.Request)}
         * @return updated request
         */
        ...
        /**
         * Specifies the signature output from the /transit/hmac function. Either this must be supplied or signature must be
         * supplied.
         *

...
public final class PkiRole {
    ...
    public static final class Request extends VaultRequest<Request> {
        ...
        /**
         * Specifies if clients can request certificates matching the value of the actual domains themselves; e.g. if a
         * configured
         * domain set with allowed_domains is example.com, this allows clients to actually request a certificate containing the
         * name example.com as one of the DNS values on the final certificate. In some scenarios, this can be considered a
         * security
         * risk.
         *
        ...
        /**
         * Specifies if clients can request certificates with CNs that are subdomains of the CNs allowed by the other role
         * options.
         ...
         * Currently, rsa and ec are supported, or when signing CSRs any can be specified to allow keys of either type and with
         * any
         ...
         * performance when issuing large numbers of certificates. However, certificates issued in this way cannot be enumerated
         * or
        ...
        /**
         * Specifies the domains of the role. This is used with the {@link #allowBareDomains} and {@link #allowSubDomains}
         * options.
         *
         * @param domain domain
         * @return updated request
         ...
         * values are valid URIs. This can be a comma-delimited list or a JSON string slice. Values can contain glob patterns
         * (e.g.
         * spiffe://hostname/*).
         *

...
module io.helidon.extensions.hashicorp.vault.secrets.kv {
    ...
    exports io.helidon.extensions.hashicorp.vault.secrets.kv2;

    provides io.helidon.extensions.hashicorp.vault.spi.SecretsEngineProvider
            with io.helidon.extensions.hashicorp.vault.secrets.kv2.Kv2EngineProvider;

    provides io.helidon.security.spi.SecurityProviderService
            with io.helidon.extensions.hashicorp.vault.secrets.kv2.Kv2SecurityService;

...
final class LangchainTypes {
    static final TypeName AI_SERVICE = TypeName.create("io.helidon.extensions.langchain4j.Ai.Service");
    static final TypeName AI_AGENT = TypeName.create("io.helidon.extensions.langchain4j.Ai.Agent");
    static final TypeName AI_CHAT_MODEL = TypeName.create("io.helidon.extensions.langchain4j.Ai.ChatModel");
    static final TypeName AI_STREAMING_CHAT_MODEL = TypeName.create("io.helidon.extensions.langchain4j.Ai.StreamingChatModel");
    static final TypeName AI_CHAT_MEMORY = TypeName.create("io.helidon.extensions.langchain4j.Ai.ChatMemory");
    static final TypeName AI_CHAT_MEMORY_WINDOW = TypeName.create("io.helidon.extensions.langchain4j.Ai.ChatMemoryWindow");
    static final TypeName AI_CHAT_MEMORY_PROVIDER = TypeName.create("io.helidon.extensions.langchain4j.Ai.ChatMemoryProvider");
    static final TypeName AI_MODERATION_MODEL = TypeName.create("io.helidon.extensions.langchain4j.Ai.ModerationModel");
    static final TypeName AI_CONTENT_RETRIEVER = TypeName.create("io.helidon.extensions.langchain4j.Ai.ContentRetriever");
    static final TypeName AI_RETRIEVER_AUGMENTOR = TypeName.create("io.helidon.extensions.langchain4j.Ai.RetrievalAugmentor");
    static final TypeName AI_TOOL_PROVIDER = TypeName.create("io.helidon.extensions.langchain4j.Ai.ToolProvider");
    static final TypeName AI_MCP_CLIENTS = TypeName.create("io.helidon.extensions.langchain4j.Ai.McpClients");
    static final TypeName AI_TOOLS = TypeName.create("io.helidon.extensions.langchain4j.Ai.Tools");
    static final TypeName AI_TOOL = TypeName.create("io.helidon.extensions.langchain4j.Ai.Tool");
    static final Annotation TOOL_QUALIFIER_ANNOTATION = Annotation.create(AI_TOOL);
    static final TypeName MODEL_CONFIG_TYPE = TypeName.create("io.helidon.extensions.langchain4j.AiProvider.ModelConfig");
    static final TypeName MODEL_CONFIGS_TYPE = TypeName.create("io.helidon.extensions.langchain4j.AiProvider.ModelConfigs");
    static final TypeName MODEL_CONFIG_KEY_TYPE = TypeName.create("io.helidon.extensions.langchain4j.AiProvider.ConfigKey");
    static final TypeName MODEL_DEFAULT_WEIGHT = TypeName.create("io.helidon.extensions.langchain4j.AiProvider.DefaultWeight");
    static final TypeName MODEL_NESTED_CONFIG = TypeName.create("io.helidon.extensions.langchain4j.AiProvider.NestedConfig");
    static final TypeName MODEL_CUSTOM_FACTORIES =
            TypeName.create("io.helidon.extensions.langchain4j.AiProvider.CustomModelFactories");

...
/**
 * Holds information needed to create an instance of {@link io.helidon.extensions.oci.v3.metrics.OciMetricsSupport}.
 * <p>
...
public abstract class OciMetricsSupportFactory {
     ...
     * an {@link io.helidon.extensions.oci.v3.metrics.OciMetricsSupport} instance and then calling back to the
    ...
    /**
     * Returns the builder for constructing a new {@link io.helidon.extensions.oci.v3.metrics.OciMetricsSupport} instance,
     ...
     * @param builder          {@link io.helidon.extensions.oci.v3.metrics.OciMetricsSupport.Builder} instance
     */

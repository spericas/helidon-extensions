...
interface OciConfigBlueprint {
     ...
     *     {@link OciConfig#allowedAuthenticationMethods()}
    ...
    /**
     * List of attempted authentication strategies in case {@link OciConfig#authenticationMethod()} is
     ...
     * @see OciConfig#authenticationMethod()
     */
    @Option.Configured
     ...
     *
     * @return information needed for config {@link OciConfig#authenticationMethod()}
     */
     ...
     *
     * @return information to customize config for {@link OciConfig#authenticationMethod()}
     */
     ...
     */
    Optional<io.helidon.config.Config> config();
}

 ...
 * <ul>
 *     <li>Create a custom service provider that provides {@link io.helidon.extensions.oci.v3.OciConfig}</li>
 *     <li>Create a file {@code oci-config.yaml} either on classpath, or in the current directory with configuration
 *     required by {@link io.helidon.extensions.oci.v3.OciConfig}, this also requires YAML config parser on classpath.</li>
 *     <li>Add environment variables to override configuration options of {@link io.helidon.extensions.oci.v3.OciConfig},
 *     such as {@code OCI_AUTHENTICATION_METHOD=config_file}</li>
 *     <li>Add system properties to override configuration options of {@link io.helidon.extensions.oci.v3.OciConfig},
 *     such as {@code oci.authenticationMethod=config_file}</li>
 * </ul>
 *
 * To customize authentication details provider, you can implement {@link io.helidon.extensions.oci.v3.spi.OciAuthenticationMethod}

...
import io.helidon.extensions.hashicorp.vault.ListSecrets;
import io.helidon.extensions.hashicorp.vault.Secrets;
...
public interface TransitSecrets extends Secrets {
     ...
     * {@link #updateKeyConfig(io.helidon.extensions.hashicorp.vault.secrets.transit.UpdateKeyConfig.Request)}
     ...
     * @return response
     * @see io.helidon.extensions.hashicorp.vault.secrets.transit.UpdateKeyConfig.Request#allowDeletion(boolean)
     */

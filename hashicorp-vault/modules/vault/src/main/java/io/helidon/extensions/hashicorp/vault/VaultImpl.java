...
import io.helidon.extensions.hashicorp.vault.spi.AuthMethodProvider;
import io.helidon.extensions.hashicorp.vault.spi.SecretsEngineProvider;
import io.helidon.extensions.hashicorp.vault.spi.SysProvider;
...
class VaultImpl implements Vault {
    ...
    private final VaultConfig prototype;

    VaultImpl(VaultConfig vaultConfig, Config config, RestApi restAccess) {
        this.prototype = vaultConfig;
        this.config = config;
        this.restAccess = restAccess;
    }

    @Override
    public VaultConfig prototype() {
        return prototype;
    }

 ...
 *
 * @param <T> type of the {@link io.helidon.extensions.hashicorp.vault.Secret} provided by the engine
 */
public interface Engine<T extends Secrets> {
     ...
     * @see io.helidon.extensions.hashicorp.vault.Vault#secrets(Engine)
     */
    Class<T> secretsType();

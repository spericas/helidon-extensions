...
import io.helidon.extensions.eureka.discovery.EurekaDiscoveryConfig.Builder;
 ...
 * begin with} {@code io.helidon.extensions.eureka.discovery.}.</p>
 *
...
public interface EurekaDiscovery extends Api<EurekaDiscoveryConfig>, Discovery {
     ...
     *                      invocation of this method would otherwise be empty; must not be {@code null}; will always be
     *                      represented as a
     *                      {@link DiscoveredUri} and included as the {@linkplain SequencedSet#getLast() last element} in the
     *                      returned {@link
     *                      SequencedSet}
     ...
     * @throws IllegalArgumentException if any argument is unsuitable in any way

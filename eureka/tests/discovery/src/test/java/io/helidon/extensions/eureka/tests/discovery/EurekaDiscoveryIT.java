...
import io.helidon.extensions.eureka.discovery.EurekaDiscovery;
...
class EurekaDiscoveryIT {
    ...
    static void beforeAll() {
        ...
        assertThat(d.getClass().getName(), is("io.helidon.extensions.eureka.discovery.EurekaDiscoveryImpl"));
    }
